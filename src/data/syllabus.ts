    ...
    semesters: [
      {
        ...
        name: "I Semester",
        subjects: [
          { code: "CS3101", title: "Data Communications and Computer Networks", credits: 3, category: "PC", syllabus: ["Data Communication Components, Networks, Protocols and Standards, Network Models (OSI, TCP/IP)", "Physical Layer: Signals, Transmission Media, Multiplexing, Switching", "Data Link Layer: Error Detection and Correction, Flow and Error Control, HDLC, MAC protocols, Ethernet", "Network Layer: Logical Addressing, IPv4/IPv6, Address Mapping, Routing Protocols", "Transport Layer: UDP, TCP, Congestion Control, Quality of Service", "Application Layer: DNS, FTP, HTTP, Email, Network Security basics"] },
          { code: "CS3102", title: "Artificial Intelligence", credits: 3, category: "PC", syllabus: ["Introduction to AI, Intelligent Agents, Problem Solving by Search", "Uninformed and Informed Search, Heuristics, A*, Local Search, Adversarial Search and Games", "Knowledge Representation, Propositional and First Order Logic, Inference, Resolution", "Planning, Reasoning under Uncertainty, Bayesian Networks", "Learning: Decision Trees, Neural Networks basics, Expert Systems, NLP introduction"] },
          { code: "CS3103", title: "Python Programming", credits: 3, category: "PC", syllabus: ["Python Basics: Data Types, Operators, Control Flow, Functions and Modules", "Strings, Lists, Tuples, Sets, Dictionaries and Comprehensions", "Object Oriented Programming: Classes, Inheritance, Polymorphism, Exception Handling", "File Handling, Regular Expressions, Standard Library Modules", "NumPy, Pandas, Matplotlib, GUI and Database Programming, Web Scraping"] },
          { code: "CS3104", title: "Data Warehouse and Data Mining", credits: 3, category: "PC", syllabus: ["Data Warehouse: Architecture, Multidimensional Data Model, OLAP Operations, Implementation", "Data Preprocessing: Cleaning, Integration, Transformation, Reduction, Discretization", "Association Rule Mining: Apriori, FP-Growth, Correlation Analysis", "Classification: Decision Trees, Bayesian, Rule Based, Neural Network Classifiers, Accuracy Measures", "Clustering: Partitioning, Hierarchical, Density Based Methods, Outlier Analysis, Mining Complex Data"] },
          { code: "CS3105", title: "Compiler Design", credits: 3, category: "PC", syllabus: ["Introduction to Compilers, Phases of a Compiler, Lexical Analysis, Finite Automata, LEX", "Syntax Analysis: Context Free Grammars, Top-Down and Bottom-Up Parsing, LL, LR, SLR, LALR, YACC", "Syntax Directed Translation, Semantic Analysis, Type Checking, Symbol Table Management", "Intermediate Code Generation: Three Address Code, Quadruples, Triples", "Code Optimization: Basic Blocks, Flow Graphs, Data Flow Analysis; Code Generation and Runtime Storage"] },
        ]
      },
      {
        id: "3-2",
        ...
        subjects: [
          { code: "CS3201", title: "Object Oriented Software Engineering", credits: 3, category: "PC", syllabus: ["Introduction to Software Engineering, Software Process Models, Agile Development", "Requirements Engineering: Elicitation, Analysis, SRS, Use Case Modelling", "Object Oriented Analysis and Design with UML: Class, Sequence, State, Activity Diagrams", "Design Principles and Patterns, Architectural Design, Component Level Design", "Software Testing: Unit, Integration, System, Object Oriented Testing; Quality Assurance, Project Management, Maintenance"] },
          { code: "CS3202", title: "Machine Learning", credits: 3, category: "PC", syllabus: ["Introduction to Machine Learning, Types of Learning, Concept Learning, Version Spaces", "Supervised Learning: Linear and Logistic Regression, Decision Trees, Naive Bayes, KNN, SVM", "Neural Networks: Perceptron, Backpropagation, Introduction to Deep Learning", "Unsupervised Learning: K-Means, Hierarchical Clustering, Dimensionality Reduction (PCA)", "Evaluation Metrics, Bias-Variance, Overfitting, Ensemble Methods, Reinforcement Learning basics"] },
          { code: "CS3203", title: "Cloud Computing", credits: 3, category: "PC", syllabus: ["Introduction to Cloud Computing, Characteristics, Evolution, Distributed and Cluster Computing", "Cloud Service Models: IaaS, PaaS, SaaS; Deployment Models: Public, Private, Hybrid, Community", "Virtualization: Hypervisors, Types of Virtualization, Containers and Docker", "Cloud Architecture, Resource Provisioning, Load Balancing, Scalability, Cloud Storage", "Cloud Security, Privacy, SLAs, Case Studies: AWS, Google Cloud, Microsoft Azure"] },
          { code: "CS3204", title: "Embedded Systems", credits: 3, category: "PC", syllabus: ["Introduction to Embedded Systems, Characteristics, Design Process, Hardware and Software Components", "Microcontrollers: Architecture, Memory, I/O Ports, Timers, Interrupts, ADC/DAC", "Embedded C Programming, Device Drivers, Interfacing Sensors and Actuators", "Real Time Operating Systems: Tasks, Scheduling, Synchronization, Inter Task Communication", "Communication Protocols: I2C, SPI, UART, CAN; Embedded System Design Case Studies and IoT"] },
          { code: "CS3205", title: "Cryptography and Network Security", credits: 3, category: "PC", syllabus: ["Security Goals, Attacks, Services and Mechanisms, Classical Encryption Techniques", "Symmetric Ciphers: DES, AES, Block Cipher Modes, Key Distribution", "Asymmetric Cryptography: Number Theory, RSA, Diffie-Hellman, Elliptic Curve Cryptography", "Message Authentication, Hash Functions (MD5, SHA), Digital Signatures, Key Management, PKI", "Network Security: IPSec, SSL/TLS, Email Security (PGP, S/MIME), Firewalls, Intrusion Detection, Malware"] },
        ]
      }
    ]
  },
